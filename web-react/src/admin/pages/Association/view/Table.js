...
export const READ_ASSOCIATIONS = gql`
...
const ViewTable = () => {
  ...
  const { loading, error, data, fetchMore } = useQuery(READ_ASSOCIATIONS, {
  ...
  const handleChangePage = (_, newPage) => {
    const currentLength = data.associations.length
              ...
              <>
                <TableContainer>
                  <Table className={classes.table}>
                    ...
                    <TableBody>
                      {data &&
                        data.associations.map(n => {
                          return (
                            <TableRow key={n.associationId}>
                              <TableCell>{n.name}</TableCell>
                              <TableCell>{n.nick}</TableCell>
                              <TableCell>
                                <LinkButton
                                  startIcon={<EditIcon />}
                                  to={getAdminAssociationRoute(n.associationId)}
                                >
                                  Edit
                                </LinkButton>
                              </TableCell>
