...
const VenuesTable = () => {
  ...
  const { loading, error, data, fetchMore } = useQuery(GET_VENUES, {
  ...
  const handleChangePage = (_, newPage) => {
    const currentLength = data.venues.length
                  ...
                  <Table className={classes.table}>
                    ...
                    <TableBody>
                      {data &&
                        data.venues.map(n => {
                          return (
                            <TableRow key={n.venueId}>
                              <TableCell>{n.name}</TableCell>
                              <TableCell>{n.nick}</TableCell>
                              <TableCell>
                                <LinkButton
                                  startIcon={<EditIcon />}
                                  to={getAdminVenueRoute(n.venueId)}
                                >
                                  Edit
                                </LinkButton>
                              </TableCell>
