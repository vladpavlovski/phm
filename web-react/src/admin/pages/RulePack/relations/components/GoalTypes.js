        ...
        renderCell: params => {
          return (
            <ButtonDialog
              ...
              dialogTitle={'Do you really want to delete this goal style?'}
              dialogDescription={'Goal style will be completely delete'}
  ...
  return (
    ...
    >
      <form
        ...
        autoComplete="off"
      >
        <DialogTitle id="alert-dialog-title">{`Add new goal style to ${rulePack?.name}`}</DialogTitle>
        <DialogContent>
          <Container>
