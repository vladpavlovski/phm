...
const SponsorsTable = () => {
  ...
  const { loading, error, data, fetchMore } = useQuery(GET_SPONSORS, {
  ...
  const handleChangePage = (_, newPage) => {
    const currentLength = data.sponsors.length
                  ...
                  <Table className={classes.table}>
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell key="legalName">Legal Name</TableCell>
                    ...
                    <TableBody>
                      {data &&
                        data.sponsors.map(n => {
                          return (
                            <TableRow key={n.sponsorId}>
                              <TableCell>{n.name}</TableCell>
                              <TableCell>{n.legalName}</TableCell>
                              <TableCell>{n.nick}</TableCell>
                              <TableCell>
                                <LinkButton
                                  startIcon={<EditIcon />}
                                  to={getAdminSponsorRoute(n.sponsorId)}
                                >
                                  Edit
                                </LinkButton>
                              </TableCell>
...
export { SponsorsTable as default }
